...
begin
	if new.lts_i <> old.lts_i then
		...
		insert into history values(old.pid, old.pname, new.desig, new.dept, old.lts_i, new.lts_O, old.lts_O, new.lts_O, old.p_status, 
			new.p_status, old.interval_time, new.interval_time, old.total_interval_time, new.total_interval_time,
			old.out_count, new.out_count, current_date, new.login_count, old.login_count);
